 ...
 *
 * @note: Added some custom hack, search `== hack start ==`.
 */
...
var render = {
  ...
  limitCropBox: function limitCropBox(sizeLimited, positionLimited) {
    ...
    if (sizeLimited) {
      ...
      var maxCropBoxWidth = canvasData.width;
      var maxCropBoxHeight = canvasData.height;
      // == hack end == //
  ...
  renderCropBox: function renderCropBox(
    ...
    if (hackLimit) {
      ...
      // == hack start == //
      if (this.action !== ACTION_ALL && this.action !== "shortcut") {
        // == hack end == //
...
var change = {
  change: function change(event) {
    ...
    if (this.limited) {
      ...
      maxWidth = canvasData.left + canvasData.width;
      maxHeight = canvasData.top + canvasData.height;
      // == hack end == //
    }

    var pointer = pointers[Object.keys(pointers)[0]];
    var range = /* == hack start == */ !pointer
      ? { x: 0, y: 0 } /* == hack end == */
      : {
    ...
    if (renderable) {
      ...
      // == hack start == //
      // this.renderCropBox();
      this.renderCropBox(hackLimit || true);
      // == hack end == //
    } // Override
